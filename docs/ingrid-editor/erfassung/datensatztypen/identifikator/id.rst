...
.. note:: Mithilfe des Identifikators der Metadaten kann nach einem bestimmten Metadatensatz gesucht werden. Hierzu wird die ID im Portal in die Suchleiste eingetragen und die Suche gestartet.
...
.. note:: Eine URI (Uniform Resource Identifier) ist eine standardisierte Zeichenkette, die man benutzt, um etwas im Internet oder in einem Datenraum eindeutig zu identifizieren.
