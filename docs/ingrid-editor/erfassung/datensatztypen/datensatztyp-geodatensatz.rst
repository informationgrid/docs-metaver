...
^^^^^^^^^^^^^^^^^^^^^
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_abschnitt-02_allgemeines/ige-abschnitt_allgemeines.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/option-inspire-relevant/checkbox-inspire-relevant-dienst.png
  :width: 150
...
.. toctree::
   ...
   ../../../ige/ige_erfassung/ige_objektklassen/option/inspire-relevant.rst


Checkbox AdV kompatibel
'''''''''''''''''''''''

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/option-adv-kompatibel/checkbox-adv-kompatibel.png
  :width: 150
...
.. toctree::
   ...
   ../../../ige/ige_erfassung/ige_objektklassen/option/adv-kompatibel.rst


Checkbox Open Data
''''''''''''''''''

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/option-open-data/checkbox-open-data.png
  :width: 150

Abb.: Checkbox Open Data

Die Checkbox Open Data ist unter Erfassung von Objekten im `Abschnitt Allgemeines <https://metaver-bedienungsanleitung.readthedocs.io/de/latest/ige/ige_erfassung/ige_objektklassen/objektklasse-geodatensatz.html#abschnitt-allgemeines>`_  beschrieben, da sie auf mehrere Metadatentypen zutrifft.

Abschnitt Verschlagwortung
^^^^^^^^^^^^^^^^^^^^^^^^^^

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_abschnitt-03_verschlagwortung/ige-abschnitt_verschlagwortung.png


ISO-Themenkategorie
'''''''''''''''''''

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/verschlagwortung_iso-themenkategorie.png

Abb.: Auswahlfeld ISO Themenkategorie

`Auswahlliste - ISO 19115 Themenkategorien <https://metaver-bedienungsanleitung.readthedocs.io/de/latest/ige/ige_auswahllisten/auswahlliste_verschlagwortung_iso-themenkategorie.html>`_
...
Die Erfassung von Freien bzw. Optionalen Schlagworten ist unter `Erfassung von Objekten Abschnitt Verschlagwortung <https://metaver-bedienungsanleitung.readthedocs.io/de/latest/ige/ige_erfassung/erfassung-objekte.html#freie-schlagworte-erfassen>`_ beschrieben.

Abschnitt Fachbezug
^^^^^^^^^^^^^^^^^^^

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_abschnitt-04_fachbezug/ige-abschnitt_fachbezug.png

Fachliche Grundlage
'''''''''''''''''''

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_fachliche-grundlage.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_identifikator_01.png

Abb.: Option Erzeuge ID

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_identifikator_02.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_identifikator_03.png
 
Abb.: Portalansicht ID aus MetaVer

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_identifikator_04.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_datensatz-datenserie.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_digitale-repaesentation.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_vektorformat.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_erstellungsmassstab.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_symbolkatalog.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_schluesselkatalog.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_sachdaten-attributinformation.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_darstellender-dienst.png
 
Abb.: Feld Darstellender Dienst

`Datenkopplung im Geodatendienst <https://metaver-bedienungsanleitung.readthedocs.io/de/latest/ige/ige_erfassung/ige_objektklassen/objektklasse-geodatendienst.html#daten-dienstekopplung>`_
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_daten-dienste-kopplung_dargestellte-daten.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_daten-dienste-kopplung_objekt-waehlen.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_daten-dienste-kopplung_verweis-anlegen.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_daten-dienste-kopplung_darstellender-dienst.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_daten-dienste-kopplung_dienst.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_datengrundlage.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/fachbezug_herstellungsprozess.png
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_abschnitt-05_datenqualitaet/ige-abschnitt_datenqualitaet.png


Der `Abschnitt Datenqualität <https://metaver-bedienungsanleitung.readthedocs.io/de/latest//ige/ige_erfassung/ige_objektklassen/qualitaetssicherung/ige_auswahllisten/abschnitt_datenqualitaet.html>`_ wird nur angezeigt, dieser in der Katalogverwaltung aktiviert wurde.



**Hinweis:** Die Abschnitte Raumbezugsystem, Zeitbezug, Zusatzinformation, Verfügbarkeit und Verweise sind ausführlich unter `Erfassung von Objekten <https://metaver-bedienungsanleitung.readthedocs.io/de/latest/ige/ige_erfassung/erfassung-objekte.html>`_  beschrieben, da sie auf mehrere Metadatentypen zutreffen.
...
.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_abschnitt-08_zusatzinformation/ige-abschnitt_zusatzinformation.png
 
Zeichensatz des Datensatzes
'''''''''''''''''''''''''''

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/zusatzinformation_zeichensatz.png
 
Abb.: Feld Zeichensatz des Datensatzes

Angaben zu dem im beschriebenen Datensatz benutzten Zeichensatz z.B. UTF-8.

`Auswahlliste Zeichensatz des Datensatzes <https://metaver-bedienungsanleitung.readthedocs.io/de/latest/ige/ige_auswahllisten/auswahlliste_zusatzinformation_zeichensatz.html>`_
  

Konformität
'''''''''''

.. image:: ../../../ige/ige_erfassung/ige_objekte/ige_objektklassen/objektklasse_geodatensatz/zusatzinformation_konformitaet.png
...
Beschreibung unter der Option `INSPIRE-relevant <https://metaver-bedienungsanleitung.readthedocs.io/de/latest/ige/ige_erfassung/ige_objektklassen/option/inspire-relevant.html>`_.
