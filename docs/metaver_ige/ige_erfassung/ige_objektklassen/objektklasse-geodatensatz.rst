...
Die Checkbox Open Data ist unter Erfassung von Objekten im `Abschnitt Allgemeines beschrieben: <https://metaver-bedienungsanleitung.readthedocs.io/de/latest/metaver_ige/ige_erfassung/ige_objektklassen/objektklasse-geodatensatz.html#abschnitt-allgemeines>`_ , da sie auf mehrere Metadatentypen zutrifft.
